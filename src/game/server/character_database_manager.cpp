                                                             ...
                                                             uint32_t hairStyle, uint32_t hairColor, uint32_t face)
{
    ...
    // Default starting position (Talking Island for humans, adjust as needed)
    character.x = -84318;
    character.y = 244579;
    character.z = -3730;
    ...
    // Equipment slots (16 slots, all empty initially)
    character.paperdoll_item_ids.resize(16, 0);
